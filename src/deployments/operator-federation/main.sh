...
kubectl apply --namespace "$namespace" -f "$deploymentPath/users-subgraph-app.yaml" > /dev/null;
...
kubectl apply --namespace "$namespace" -f "$deploymentPath/posts-subgraph-app.yaml" > /dev/null;
...
kubectl apply --namespace "$namespace" -f "$deploymentPath/comments-subgraph-app.yaml" > /dev/null;
...
kubectl apply --namespace "$namespace" -f "$deploymentPath/notifications-subgraph-app.yaml" > /dev/null;
