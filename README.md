...
- `tyk-cp`: Tyk self-managed multi region control plane (Will be available in Q1 2024 on, please use the [v2 tag](https://github.com/TykTechnologies/tyk-k8s-demo/tree/v2) if you would like to deploy this.)
